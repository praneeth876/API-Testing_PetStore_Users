...
//		Assert.assertEquals(acceptheader,"application/json");
	...
	public void test_getUser() {
		...
		Response res=UserEndpoints2.getUser(this.user.getUsername());
		res.then().log().all();
...
//		Assert.assertEquals(acceptheader,"application/json");
	...
	public void test_putUser() {
		...
		Response res=UserEndpoints2.updateUser(user,this.user.getUsername());
		res.then().log().body();
...
//		Assert.assertEquals(acceptheader,"application/json");
	...
	public void test_deleteUser() {
		...
		Response res=UserEndpoints2.removeUser(user.getUsername());
		res.then().log().all();
